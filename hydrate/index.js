...
const NAMESPACE = 'stencil-bug-reproduction';
...
const myComponentCss = ":host{display:block}.my-component-child{background-color:red}";
...
class MyComponent {
    ...
    render() {
        return hAsync("div", { key: '70654fc83039b5f659efe99cc990e9b86d20dbe0' }, "Hello, World! I'm ", this.getText(), hAsync("div", { key: 'e05ece71eeb80c0036c59008d82900ce423bf25e', class: "my-component-child" }, hAsync("p", { key: 'a2c199373781643b39cd113b01e5bcad0255a844' }, " This is a text el")));
    }
